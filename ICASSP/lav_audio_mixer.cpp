...
void lavAudioMixer::record_output(char* fileName, int durationInMs)
{
    ...
    //lavLog::LOG("record_output::_nbChunkToRecord", _nbChunkToRecord);
...
void lavAudioMixer::recordCurrentAudioChunk(void* currentAudioChunck)
{
    ...
    //lavLog::LOG("recordCurrentAudioChunk", _cptRecordedAudioChunk);
    ...
    if (_cptRecordedAudioChunk>_nbChunkToRecord) {
        ...
        lavWav::writeStandardWavFile(_recordingFileName, "SHORT", (char*) _arrayForWaveFile, SIZE_AUDIO_CHUNK_IN_BYTE*_nbChunkToRecord);
        //lavLog::LOG("RECORD !!!!", _recordingFileName);
    }
}
...
void lavAudioMixer::push_buffer(void* pointer_data)
{
	...
	if (_cptVideoFrame%30==0) {
	    lavConstants::__stopTimeChecking("lavAudioMixer::push_buffer");
	    lavConstants::__startTimeChecking();
	}
    //lavLog::LOG(">> push_buffer", _cptVideoFrame);
...
void* lavAudioMixer::pull_buffer()
{
    ...
    //lavLog::LOG("pull_buffer", _cptVideoFrame);
