...
std::mutex lavAudioMixer::_buffer_mutex;
char* lavAudioMixer::_obstacle_buffer_reading = 0;
...
void lavAudioMixer::init() {
    ...
    _obstacle_buffer_reading = (char*) calloc(SIZE_SOUND_IN_BYTE, sizeof(char));
    ...
    memset(_obstacle_buffer_reading, 0, sizeof(char)*SIZE_SOUND_IN_BYTE);
    memset(_sonification_buffer_reading, 0, sizeof(char)*SIZE_SOUND_IN_BYTE);
    memset(_audio_output_buffer, 0, sizeof(char)*SIZE_SOUND_IN_BYTE);
    memset(_beginning_audio_buffer, 0, sizeof(char)*SIZE_AUDIO_CHUNK_IN_BYTE);
