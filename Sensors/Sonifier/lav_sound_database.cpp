...
void lavSoundDatabase::initFromWav() {
    ...
    SonifierLogger::logger("initFromWav\n");
...
void lavSoundDatabase::init() {
    ...
    SonifierLogger::logger("init sound database\n");
    ...
    SonifierLogger::logger("Init from wave finished\n");
}
