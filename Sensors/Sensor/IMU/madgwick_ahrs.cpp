...
Madgwick::Madgwick() : Madgwick(betaDef) {}
...
void Madgwick::update(float gx, float gy, float gz, float ax, float ay,
    ...
    q.q0 += qDot1 * this->dtime;
    q.q1 += qDot2 * this->dtime;
    q.q2 += qDot3 * this->dtime;
    q.q3 += qDot4 * this->dtime;
...
void Madgwick::updateIMU(float gx, float gy, float gz, float ax,
    ...
    if (!((ax == 0.0f) && (ay == 0.0f) && (az == 0.0f))) {
        ...
        s1 = _4q1 * q3q3 - _2q3 * ax + 4.0f * q0q0 * q.q1 - _2q0 * ay - _4q1 +
             _8q1 * q1q1 + _8q1 * q2q2 + _4q1 * az;
        s2 = 4.0f * q0q0 * q.q2 + _2q0 * ax + _4q2 * q3q3 - _2q3 * ay - _4q2 +
