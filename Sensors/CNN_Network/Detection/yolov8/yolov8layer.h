...
namespace nvinfer1 {
class API Yolov8LayerPlugin : public IPluginV2IOExt {
public:
        Yolov8LayerPlugin(int classCount, int netWdith, int netHeight, int maxOut);
        Yolov8LayerPlugin(const void* data, size_t length);
        ~Yolov8LayerPlugin();
...
class API YoloV8PluginCreator : public IPluginCreator {
public:
        YoloV8PluginCreator();
        ~YoloV8PluginCreator() override = default;
    ...
    REGISTER_TENSORRT_PLUGIN(YoloV8PluginCreator);
} // namespace nvinfer1
